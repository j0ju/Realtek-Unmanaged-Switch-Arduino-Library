...
static rtk_api_ret_t _rtk_vlan_init(void)
{
    ...
    RTK_SCAN_ALL_PHY_PORTMASK(i)
    {
        if ((retVal = rtl8367c_setAsicVlanIngressFilter(i, RTK_ENABLED)) != RT_ERR_OK)
            return retVal;
    }

    /* enable VLAN */
    if ((retVal = rtl8367c_setAsicVlanFilter(RTK_ENABLED)) != RT_ERR_OK)
        return retVal;
...
{
    return _rtk_vlan_set(vid, pVlanCfg);
}
...
{
    return _rtk_vlan_get(vid, pVlanCfg);
}
...
{
    return _rtk_vlan_egrFilterEnable_set(egrFilter);
}
...
{
    return _rtk_vlan_egrFilterEnable_get(pEgrFilter);
}
...
{
    return _rtk_vlan_mbrCfg_set(idx, pMbrcfg);
}
...
{
    return _rtk_vlan_mbrCfg_get(idx, pMbrcfg);
}
...
{
    return _rtk_vlan_portPvid_set(port, pvid, priority);
}
...
{
    return _rtk_vlan_portPvid_get(port, pPvid, pPriority);
}
...
{
    return _rtk_vlan_portIgrFilterEnable_get(port, pIgr_filter);
}
...
{
    return _rtk_vlan_portAcceptFrameType_set(port, accept_frame_type);
}
...
{
    return _rtk_vlan_portAcceptFrameType_get(port, pAccept_frame_type);
}
...
{
    return _rtk_vlan_protoAndPortBasedVlan_add(port, pInfo);
}
...
{
    return _rtk_vlan_protoAndPortBasedVlan_get(port, proto_type, frame_type, pInfo);
}
...
{
    return _rtk_vlan_protoAndPortBasedVlan_del(port, proto_type, frame_type);
}
...
{
    return _rtk_vlan_protoAndPortBasedVlan_delAll(port);
}
...
{
    return _rtk_vlan_tagMode_set(port, tag_mode);
}
...
{
    return _rtk_vlan_tagMode_get(port, pTag_mode);
}
...
{
    return _rtk_vlan_transparent_set(egr_port, pIgr_pmask);
}
...
{
    return _rtk_vlan_transparent_get(egr_port, pIgr_pmask);
}
...
{
    return _rtk_vlan_keep_set(egr_port, pIgr_pmask);
}
...
{
    return _rtk_vlan_keep_get(egr_port, pIgr_pmask);
}
...
{
    return _rtk_vlan_stg_set(vid, stg);
}
...
{
    return _rtk_vlan_stg_get(vid, pStg);
}
...
{
    return _rtk_vlan_portFid_set(port, enable, fid);
}
...
{
    return _rtk_vlan_portFid_get(port, pEnable, pFid);
}
...
{
    return _rtk_vlan_UntagDscpPriorityEnable_set(enable);
}
...
{
    return _rtk_vlan_UntagDscpPriorityEnable_get(pEnable);
}
...
{
    return _rtk_stp_mstpState_set(msti, port, stp_state);
}
...
{
    return _rtk_stp_mstpState_get(msti, port, pStp_state);
}
...
{
    return _rtk_vlan_reservedVidAction_set(action_vid0, action_vid4095);
}
...
{
    return _rtk_vlan_reservedVidAction_get(pAction_vid0, pAction_vid4095);
}
...
{
    return _rtk_vlan_realKeepRemarkEnable_set(enabled);
}
...
{
    return _rtk_vlan_realKeepRemarkEnable_get(pEnabled);
}
